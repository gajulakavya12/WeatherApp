...
- **Multiple Cities** - Compare the weather of different cities.
- **5-Day Forecast** - Display weather predictions for upcoming days.
- **Error Handling** - Improve handling of invalid city names or network errors.
- **Dark Mode** - Add a night-friendly mode for better UX.
